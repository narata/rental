                ...
                <el-col :span="10" :offset="2">
                    <div class="show-in">
                        <el-card class="box-card">
                            <div class="text item">
                                <el-tag type="success" v-if="house.status===0">未租到</el-tag>
                                <el-tag type="danger" v-else>已租到</el-tag>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getPage(current) {
                this.axios.post('/api/house/list?self=0&current=' + current + '&size=' + this.size,
                    this.search_data
                ).then((res) => {
                    if (res.status === 200) {
                        this.data = res.data
