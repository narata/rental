<template>
    <div id="main">
        <el-header>
            <Menu active-index="3"></Menu>
        </el-header>
        <el-main class="show">
            <el-form ref="form" :model="form" status-icon label-width="60px" :rules="rules" label-position="left">
                <el-form-item label="类型" prop="rent_house">
                    <el-select v-model="form.rent_house" placeholder="选择帖子类型">
                        <el-option label="房源信息" value="0"></el-option>
                        <el-option label="求租信息" value="1"></el-option>
                    </el-select>
                </el-form-item>
